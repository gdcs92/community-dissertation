...
n = 1000
#p = 0.01
columns = ['acuracia','onelabels','niter']
...
for i,d in enumerate(dvals):
    ...
    for m in range(M): # instancias
        ...
        for r in range(R): # repeticoes
            ...
            results = bootstrap(sbm,nrounds,restart=a)
...
file_location = './data/'
file_name = f'g1_n{n:d}_p{p:.4f}_R{R:d}_M{M:d}_s{sbm_seed:d}_{a:s}.data'
